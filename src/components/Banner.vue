...
<template>
    <div class="banner" id="banner">
        <!-- 加载层 -->
        <div class="bg back"><h1>墨小菲奋笔疾书...</h1></div>
        <!-- 脚贴 -->
        <div class="fork-me">
            <a class="fork-me-link" href="https://github.com/zy84338719" target="_blank">
                <span class="fork-me-text">Get GitHub</span>
            </a>
        </div>
        <!-- 背景层 -->
        ...
        <div data-aos="fade-in" class="desc">
            ...
            <div>
                <h1>{{banner.title || '墨菲易'}}</h1>
                <h3 class="typer white">
                    鄙人，
                    <vue-typer :text="banner.desc || '墨菲'" :type-delay='200' eraseStyle='select-all'></vue-typer>
                </h3>
            </div>
        </div>
